package com.example.ysfsaifexamfinal;
...
import com.example.ysfsaifexamfinal.beans.Crenau;
...
public class MainActivity extends AppCompatActivity {
    ...
    String insertUrll = "http://192.168.99.138:3000/crenau/api";
    String insertUrl = "http://192.168.99.138:3000/occupation/api";
                ...
                public void onDecoded(@NonNull @NotNull Result result) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            System.out.println(anass+"ghvggvv");
                            ...
                            intent.putExtra("idSalle",result.getText());
